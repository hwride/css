...
export function renderTableContent() {
  ...
  addRowExpression('window.visualViewport.offsetLeft')
  addRowExpression('window.visualViewport.pageLeft')
  ...
  addRowExpression('window.visualViewport.offsetTop')
  addRowExpression('window.visualViewport.pageTop')
  addRowExpression('window.visualViewport.scale')
